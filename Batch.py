...
average_error = []
#hyperparameters
batch_size = 354 #this can be changed
...
for j in range(epochs):
  for epoch in range(len(x_train)):
    ...
    if epoch % batch_size-1 == 0 and epoch!=0: # weights aren't updated until batch size is reached, until then the grads keep adding up
